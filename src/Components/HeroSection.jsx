...
const HeroSection = () => {
    return (
        <>
            ...
            <section className=' lg:px-24 pt-10  hero-section' >
                ...
                <div className=' flex  flex-col  justify-center items-center p-2 lg:p-0'>
                    <p className=' text-[1.2rem] font-medium'> Trusted by talents with <span className=' text-[#2B54FF]'>$240K+ compensation offers</span> at</p>
